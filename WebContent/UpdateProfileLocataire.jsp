            ...
            <div class="col-md-6 col-lg-4">
              <div class="property-agent">
                <p class="color-text-a">
                    <form class="form-a contactForm"  action='${pageContext.request.contextPath}/LocataireServlet' enctype="multipart/form-data"  method ="post" >
                ...
                <p class="color-text-a">
                  ...
                  <div class="form-group">
                    <h5>GSM</h5>
                      <input name="GSM" type="text" value= "${locataire.GSM}" class="form-control form-control-lg form-control-a" >
                    </div>
                </p>
                <p class="color-text-a">
                  <div class="form-group">
                    <h5>Description:</h5>
                      <textarea name="description"  class="form-control form-control-lg form-control-a"rows="3">${locataire.description}</textarea>
                    </div>
                </p>
        </div>
            </div>
            <div class="col-md-12 col-lg-4">
              <div class="property-contact">
                  ...
                  <div class="row">
                   ...
                   <div class="form-group">
                    <h5>Age:</h5>
                     <input name="age" type="text" class="form-control form-control-lg form-control-a" value="${locataire.age}">
                   </div>
                   </div>
                   <div class="form-group">
                   <div class="col-md-12 mb-1">
 				 ...
 				 <select name="sexe" class="custom-select">
 					 <option selected  value="${locataire.sexe}">${locataire.sexe}</option>
				...
				<div class="col-md-12 mb-1">
                   <div class="form-group">
                    <h5>Nombre de locataires : </h5>
                     <input name="nombre_personnes" type="text" class="form-control form-control-lg form-control-a" value="${locataire.nombre_personnes}">
                   </div>
                   </div>
                  <div class="col-md-12 mb-1">
                   <div class="form-group">
                    <h5>Budget : </h5>
                     <input name="budget" type="text" class="form-control form-control-lg form-control-a" value="${locataire.budget}">
                   </div>
                   </div>
                   <div class="col-md-12 mb-1">
                   <div class="form-group">
                    <h5>Profession : </h5>
                     <input name="profession" type="text" class="form-control form-control-lg form-control-a" value="${locataire.profession}">
                   </div>
                   </div>
                <div class="col-md-12 mb-1">
                      <div class="form-group">
                   ...
                   <select name="organisation" class="custom-select">
 					 <option selected  value="${locataire.organisation}">${locataire.organisation}</option>
                    ...
                    <select name="nettoyage" class="custom-select">
 					 <option selected  value="${locataire.nettoyage}">${locataire.nettoyage}</option>
  					 <option  value="Jamais">Jamais</option>
  					 <option  value="Parfois">Parfois</option>
  					 <option  value="Regulierement">Régulièrement</option>
				</select>
                   ...
                   <select name="fumer" class="custom-select">
 					 <option selected  value="${locataire.fumer}">${locataire.fumer}</option>
  					 <option  value="Jamais">Jamais</option>
  					 <option  value="Parfois">Parfois</option>
  					 <option  value="Regulierement">Régulièrement</option>
				</select>
