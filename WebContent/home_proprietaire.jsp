       ...
       <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
             <c:if test = "${user.statut == 'locataire'}" > 
                   ...
                   <a class="nav-link active" href = "FindProprietaire.jsp">Chercher un propri�taire</a>
               </c:if>
                <c:if test = "${user.statut == 'proprietaire'}" > 
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
             ...
             <c:if test = "${user.statut == 'locataire'}" > 
              ...
              <a class="dropdown-item" href = "${pageContext.request.contextPath}/LocataireServlet?action=UpdateProfile&id=${user.id_user}">Mettre � jour</a>
            	 </c:if>
           </div>
          </li>
          <li class="nav-item">
      ...
      <div class="row">
          ...
          <div class="card-box-c foo">
            <div class="card-header-c d-flex">
              <div class="card-title-c align-self-center">
                <h2 class="title-c">Sp�cialis� en location,pas en vacances</h2>
              </div>
            </div>
            <div class="card-body-c">
              <p class="content-c">
                Les locataires restent g�n�ralement des mois, pas des jours. Nous exigeons une v�rification des locataires, soutenons les baux et les d�p�ts de garantie, et permettons aux locataires de trouver des colocataires pour les espaces � plusieurs lits
              </p>
            </div>
        ...
        <div class="col-md-4">
          <div class="card-box-c foo">
            <div class="card-header-c d-flex">
              <div class="card-title-c align-self-center">
                <h2 class="title-c">Au service d'une vari�t� de locataires professionnels</h2>
              </div>
            </div>
            <div class="card-body-c">
              <p class="content-c">
                Les locataires d�m�nagent pour de nouvelles opportunit�s de travail ou d'�ducation. Cela comprend les stagiaires, les infirmi�res de voyage, les �tudiants dipl�m�s et doctorants, les nomades num�riques et les personnes qui d�m�nagent dans une nouvelle ville.
              </p>
            </div>
            <div class="card-footer-c">
              <a href="#" class="link-c link-icon">Lire plus
