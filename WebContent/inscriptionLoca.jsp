...
<% 
    ...
    if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("insert into user(nom,prenom,email,password,statut)values(?,?,?,?,'locataire')", Statement.RETURN_GENERATED_KEYS);
        pst.setString(1, nom);
        ...
        if (result.next()) {
            ...
            pstm= con.prepareStatement("insert into locataire(id_user)values(?)") ;
            pstm.setLong(1,id);
            pstm.executeUpdate();
        }
        }
                    ...
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" action="#" method="post">
                         <h3 class="text-center text">Inscrivez vous</h3>
                            ...
                            <div class="form-group">
                                <label for="password" class="text">Confirmation du mot de passe:</label><br>
                                <input type="password" name="confirmation" id="password" class="form-control" required>
                            </div>
                           <div class="form-group">
                                <br>
