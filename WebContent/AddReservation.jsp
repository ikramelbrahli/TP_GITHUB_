          ...
          <div class="row">
            ...
            <div class="col-md-6 col-lg-4">
              <div class="property-agent">
                ...
                <div class="col-sm-12">
              <div class="title-box-d">
                <h3 class="title-d">Formulaire de réservation</h3>
              </div>
            </div>
                    <form class="form-a contactForm"  action='${pageContext.request.contextPath}/ReservationServlet'  method ="post" >
                  ...
                  <div class="form-group">
                    <h5>Date move-in</h5>
                      <input name="date_move_in" type="date"  class="form-control form-control-lg form-control-a" >
                    </div>
                </p>
                 <p class="color-text-a">
                  <div class="form-group">
                    <h5>Date move-out</h5>
                      <input name="date_move_out" type="date"  class="form-control form-control-lg form-control-a" >
                    </div>
                </p>
              
                   
                <div class="col-md-12">
                      <button type="submit" name="submit" class="btn btn-a-lg">Envoyer une demande de réservation </button>              
                    </div>
                    </form>
