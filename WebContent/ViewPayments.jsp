          ...
          <div class="row">
            ...
            <div class="col-md-6 col-lg-4">
              <div class="property-agent">
                ...
                <div class="col-sm-12">
              <div class="title-box-d">
                <h3 class="title-d">Paiements : </h3>
                   <a href="${pageContext.request.contextPath}/ReservationServlet?action=ViewAllReservations&id=${user.id_user}" class="btn btn-success btn-lg active" role="button" aria-pressed="true">Consulter vos Réservations</a>
              </div>
            </div>
 				 ...
 				 <tbody>
   					 <tr>
     				 <th scope="row">${paiement.id_paiment}</th>
