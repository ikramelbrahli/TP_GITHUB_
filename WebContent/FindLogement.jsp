              ...
              <div class="card-overlay">
                <div class="card-overlay-a-content">
                  ...
                  <div class="card-body-a">
                    ...
                    <p>
                     <a href="${pageContext.request.contextPath}/ReservationServlet?action=AddReservation&id_logement=${logement.id_logement}&id=${user.id_user}" class="link-a">Réserver
                      <span class="ion-ios-arrow-forward"></span>
                    </a>
                    </p>
                  </div>
