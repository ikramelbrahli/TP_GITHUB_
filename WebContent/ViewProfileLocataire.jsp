      ...
      <div class="row">
        <div class="col-md-12 col-lg-8">
          <div class="title-single-box">
            <h1 class="title-single">${locataire.prenom} ${locataire.nom}</h1>
              ...
              <div class="agent-info-box">
                <div class="agent-title">
                  <div class="title-box-d">
                    <h3 class="title-d">${locataire.prenom}
                      <br> ${locataire.nom}</h3>
                  </div>
                </div>
                <div class="agent-content mb-3">
                  ...
                  <div class="info-agents color-a">
                    ...
                    <p>
                      <strong>GSM: </strong>
                      <span class="color-text-a"> ${locataire.GSM}</span>
                    </p>
                    <p>
                      <strong>Age: </strong>
                      <span class="color-text-a"> ${locataire.age}</span>
                    </p>
                    <p>
                      <strong>Sexe: </strong>
                      <span class="color-text-a"> ${locataire.sexe}</span>
                    </p>
                    <p>
                      <strong>Email: </strong>
                      <span class="color-text-a"> ${locataire.email}</span>
                    </p>
                    <p>
                      <strong>Organisation:</strong>
                      <span class="color-text-a">${locataire.organisation}</span>
                    </p>
                    <p>
                      <strong>Nettoyage:</strong>
                      <span class="color-text-a"> ${locataire.nettoyage}</span>
                    </p>
                    <p>
                      <strong>Fumer: </strong>
                      <span class="color-text-a"> ${locataire.fumer}</span>
                    </p>
                     <p>
                      <strong>Profession: </strong>
                      <span class="color-text-a"> ${locataire.profession}</span>
                    </p>
                     <p>
                      <strong>Budget: </strong>
                      <span class="color-text-a"> ${locataire.budget}</span>
                    </p>
                     <p>
                      <strong>Nombre de locataires: </strong>
                      <span class="color-text-a"> ${locataire.nombre_personnes}</span>
                    </p>
                  </div>
                </div>
